...
const AdminSummary = () => {
  return (
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'> 
            ...
            <SummaryCard icon={<FaBuilding/>} text="Total Departments" number={6} color="bg-yellow-600"/>
            <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Pay" number="$6523" color="bg-red-600"/>
         ...
         <div className='mt-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2  gap-6 mt-6'>
                ...
                <SummaryCard icon={<FaCheckCircle/>} text="Leave Approves" number={2} color="bg-green-600"/>
